                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <?php if ($_SESSION['jabatan']=='Tata Usaha') { ?>
                            <li>
                                <a href="../admin/data-kategori.php"><i class="fa fa-sticky-note-o"></i><span>Kategori</span></a>
                            </li>
                            <li>
                                <a href=""><i class="fa fa-trophy"></i><span>Pengajuan Data &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pribadi</span>
                                ...
                                <ul class="collapse">
                                    <li>
                                        <a href="pengajuan-data-pribadi.php"><i class="fa fa-hourglass-2"></i><span>Pengajuan</span>
                                        <?php include 'koneksi.php';
                                            $query3=mysql_query("
                                                SELECT (SELECT COUNT(status_pdk) FROM pendidikan WHERE status_pdk='Pengajuan')+(SELECT COUNT(status_kependudukan) FROM kependudukan WHERE status_kependudukan ='Pengajuan')+(SELECT COUNT(status_keluarga) FROM keluarga WHERE status_keluarga ='Pengajuan') AS dptotal");
                                            $var3=mysql_fetch_array($query3);
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-exclamation"></i><span>&nbsp;Tidak Valid</span>></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="active">
                                <a href="#"><i class="fa fa-sticky-note-o"></i>
                                    <span>Pengajuan<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sertifikat
                                    </span>
                                        <?php include 'koneksi.php';
                                            $query2=mysql_query("
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active">
                                        <a href="sertifikat-tidak-valid.php"><i class="fa fa-exclamation"></i><span>&nbsp;Tidak Valid</span></a>
                                    </li>
                                </ul>
                            </li>
                            <?php } ?>
                            <li>
                                <a href="#" aria-expanded="true"><i class="fa fa-database"></i> <span>Sertifikat<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Mahasiswa</span><</a>
                                <ul class="collapse">
                                    <li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Sertifikat Tidak Valid</h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Sertifikat Tidak Valid</h4>
                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"><?php echo $var['kategori_sertifikat']; ?></td>
