                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Daftar Mahasiswa</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <tbody>
                                            <?php include 'koneksi.php';
                                                $query=mysql_query("SELECT * FROM mahasiswa ORDER BY id_mhs");
                                                $no=0;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="profil-mhs.php?id_mhs=<?php echo $var['id_mhs']; ?>">Lihat</a>
                                                </td>
                                                <td>
                                                    <a href="cetak-biodata-mhs.php?id_mhs=<?php echo $var['id_mhs']; ?>" target="_BLANK">
                                                        Cetak
                                                    </a>
                                                </td>
                                            </tr>
    ...
    'responsive':true,
        ...
        buttons: [
            ...
            { 
                ...
                title:'',
                messageTop: '<center><img src="<?php echo '../assets/images/header.jpg'; ?>"><br><br><h1>Daftar Mahasiswa</h1></center><br>' 
            }
        ]
    } );
    table.draw();
