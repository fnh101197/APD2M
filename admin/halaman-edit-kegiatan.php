...
<head>
    ...
    <title>Edit Kegiatan Mahasiswa</title>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="edit-kegiatan.php" method="POST" name="input" novalidate="" ENCTYPE="multipart/form-data">
                                    ...
                                    <input type="hidden" name="id_sertifikat" value="<?php echo $id_sertifikat;?>">
                                        ...
                                        <? } ?>
                                        <div> 
                                            <input type="submit" name="edit-kegiatan" class="btn btn-primary">
