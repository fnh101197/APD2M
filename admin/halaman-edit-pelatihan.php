...
<head>
    ...
    <title>Edit Pelatihan Mahasiswa</title>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="edit-pelatihan.php" method="POST" name="input" novalidate="" ENCTYPE="multipart/form-data">
                                    <h4 class="header-title">Edit Pelatihan</h4>
                                    <input type="hidden" name="id_sertifikat" value="<?php echo $id_sertifikat;?>">
                                        ...
                                        <? } ?>
                                        <div>
                                            <input type="submit" name="edit- class=" class="btn btn-primary">
