...
<head>
    ...
    <title>Edit Seminar Mahasiswa</title>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="edit-seminar.php" method="POST" name="input" novalidate="" ENCTYPE="multipart/form-data">
                                    <h4 class="header-title">Edit Data Seminar</h4>
