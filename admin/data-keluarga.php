                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"><?php echo $var['status_kawin']; ?></td>
                                                <td align="left"><?php echo $var['nm_ayah']; ?></td>
                                                <td><?php echo $var['nm_ibu']; ?></td>
                                                <td><?php echo $var['jml_sdr']; ?></td>
                                                <td>
                                                    <a href="tinjau-data-keluarga.php?id_kk=<?php echo $var['id_kk'] ?>" class="btn btn-primary btn-xs mb-3" title="butuh perbaikan" target="_BLANK">Lihat</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
    ...
    'responsive':true,
        ...
        buttons: [
            ...
            { 
                ...
                title:'',
                messageTop: '<center><img src="<?php echo '../assets/images/header.jpg'; ?>"><br><br><h1>Rekap Data Keluarga</h1></center><br>'  
            }
        ]
    } );
    table.draw();
