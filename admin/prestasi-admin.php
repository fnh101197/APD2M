                            ...
                            <div class="row">
                                <div class="iv-left col-6">
                                    <div class="header-title">
                                       <h4 class="header-title">Data Prestasi</h4>
                                    </div>
                                </div>
                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $reload = "prestasi-admin.php?page=true&keyword=$keyword";
                                                $sql =
                                                    "SELECT
                                                        s.id_sertifikat, 
                                                        s.asal,
        ...
        'buttons':true,
            ...
            buttons: [
                ...
                { 
                    ...
                    title : '',
                    messageTop: '<center><img src="<?php echo '../assets/images/header.jpg'; ?>"><br><br><h1>Rekap Prestasi</h1></center><br>'         
