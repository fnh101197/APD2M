...
<html class="no-js" lang="en">
    <?php 
        include 'koneksi.php';
        $id_ks=$_GET['id_ks'];
        $query=mysql_query("select * from kategori_sertifikat where id_ks='$id_ks'");
    ?>
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Edit Kategori Sertifikat</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Kategori</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="edit-kategori.php" method="POST" name="input">
                                    <h4 class="header-title">Edit Kategori Sertifikat</h4>
                                    <input type="hidden" name="id_ks" value="<?php echo $id_ks;?>">
                                        <div class="form-group">
                                            <label for="">Nama Kategori</label>
                                            <input type="text" class="form-control col-4" id="" name="nm_ks" value="<?php echo $row['nm_ks']; ?>" required="" placeholder="nama">
                                        </div>
                                         <div class="form-group">
                                            <label for="">Singkatan</label>
                                            <input type="text" class="form-control col-4" id="" name="singkatan_ks" value="<?php echo $row['singkatan_ks']; ?>" required="" placeholder="nik">
                                        </div>
                                        <div>
                                            <input type="submit" name="edit-kategori" class="btn btn-primary">
