                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Data Kategori</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <h4 class="header-title">Data Kategori Sertifikat</h4>&nbsp;&nbsp;&nbsp;
                                    <button class="btn btn-primary btn-xs mb-3" data-toggle="modal" data-target=".bd-example-modal-lg" type="button"><i class="fa fa-user-plus"> Tambah Kategori</i></button>
                                    <!-- Large modal start -->
                                    <div class="modal fade bd-example-modal-lg">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <!-- Server side start -->
                                                    <div class="card-body">
                                                        <form class="needs-validation" novalidate="" method="POST" action="tambah-kategori.php" name="input">
                                                            <div class="form-row">
                                                                <div class="col-md-4 mb-3">
                                                                    <label for="validationCustom05">Nama</label>
                                                                    <input type="text" class="form-control" id="validationCustom05" placeholder="Nama" name="nm_ks" required="">
                                                                ...
                                                                <div class="col-md-4 mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" id="validationCustom05" placeholder="Username" name="singkatan_ks" required="">
                                                                    <div class="invalid-feedback">
                                                                        Masukan Singkatan
                                                                    </div>
                                                                </div>
                                ...
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <tbody>
                                            <?php include 'koneksi.php';
                                                $query=mysql_query("SELECT * FROM kategori_sertifikat ORDER BY id_ks");
                                                $no=0;
                                            ...
                                            <tr>
                                                <td><?php echo $no; ?></td>
                                                <td><?php echo $var['nm_ks']; ?></td>
                                                <td><?php echo $var['singkatan_ks']; ?></td>
                                                <td>
                                                    <a href="hapus-kategori.php?id_ks=<?php echo $var['id_ks'];?>"><i class="ti-trash" title="hapus"  
                                                        onclick="javascript: return confirm('Anda Yakin Hapus?');" ></i></a>
                                                    <a href="halaman-edit-kategori.php?id_ks=<?php echo $var['id_ks'] ?>" ><i class="fa fa-edit" title="edit"></i>  
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php } ?>
    ...
    'responsive':true,
        ...
        buttons: [
            ...
            { 
                ...
                title:'',
                messageTop: '<center><img src="<?php echo '../assets/images/header.jpg'; ?>"><br><br><h1>Kategori Sertifikat</h1></center><br>'  
            }
        ]
    } );
    table.draw();
