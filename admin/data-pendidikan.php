                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"><?php echo $var['asal_sekolah']; ?></td>
                                                <td align="left"><?php echo $var['jurusan_sekolah']; ?></td>
                                                <td><?php echo $var['thn_angkatan']; ?> - <?php echo $var['thn_lulus']; ?></td>
                                                <td>
                                                    <a href="tinjau-data-pendidikan.php?no_pdk=<?php echo $var['no_pdk'] ?>" class="btn btn-primary btn-xs mb-3" title="butuh perbaikan" target="_BLANK">Lihat</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
    ...
    'responsive':true,
        ...
        buttons: [
            ...
            { 
                ...
                title:'',
                messageTop: '<center><img src="<?php echo '../assets/images/header.jpg'; ?>"><br><br><h1>Rekap Data Pendidikan</h1></center><br>'  
            }
        ]
    } );
    table.draw();
