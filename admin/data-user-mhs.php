                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Data User Mahasiswa</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <h4 class="header-title">Data Akun Mahasiswa</h4>&nbsp;&nbsp;&nbsp;
                                    <button class="btn btn-primary btn-xs mb-3" data-toggle="modal" data-target=".bd-example-modal-lg" type="button"><i class="fa fa-user-plus"> Tambah Akun Mahasiswa</i></button>
                                    <!-- Large modal start -->
                                    <div class="modal fade bd-example-modal-lg">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <!-- Server side start -->
                                                    <div class="card-body">
                                                        <form class="needs-validation" novalidate="" method="POST" action="tambah-user-mhs.php" name="input" enctype="multipart/form-data">
                                                            <div class="form-row">
                                                                <div class="col-md-4 mb-3">
                                                                    <label for="validationCustom05">Nama</label>
                                                                    <input type="text" class="form-control"
                                                                        id="validationCustom05" placeholder="Nama"
                                                                        name="nama_mhs" required="">
                                                                    <div class="invalid-feedback">
                                                                        Masukan Nama
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4 mb-3">
                                                                    <label for="validationCustom05">NPM</label>
                                                                    <input type="text" class="form-control"
                                                                        id="validationCustom05" placeholder="NPM"
                                                                        name="npm" required="">
                                                                    <div class="invalid-feedback">
                                                                        Masukan NPM
                                                                    </div>
                                                                ...
                                                                <div class="col-md-4 mb-3">
                                                                    <label for="validationCustom05">Angkatan</label>
                                                                    <input type="text" class="form-control"
                                                                        id="validationCustom05" placeholder="angkatan"
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-4 mb-3">
                                                                    <label for="validationCustom05">Jurusan</label>
                                                                    <select name="jurusan" type="text" class="custom-select" id="validationCustom05" required="">
                                                                        <option>D3 Sistem Informasi</option>
                                                                        <option>D3 Teknik Komputer</option>
                                                                        <option>D3 Akuntansi</option>
                                                                        <option>D3 Perbankan</option>
                                                                        <option>D3 Perpajakan</option>
                                                                    </select>
                                                                    <div class="invalid-feedback">
                                                                        Masukan Jurusan
                                                                    </div>
                                                                ...
                                                                <div class="col-md-4 mb-3">
                                                                    <label for="validationCustom05">Fakultas</label>
                                                                   <select name="fakultas" type="text" class="custom-select" id="validationCustom05" required="">
                                                                ...
                                                                <div class="col-md-4 mb-3">
                                                                    <label for="validationCustom05">Angkatan</label>
                                                                    <select class="form-control" id="validationCustom05" name="jk" required="">
                                ...
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2" class="text-center">
                                        ...
                                        <tbody>
                                            <?php include 'koneksi.php';
                                                $query=mysql_query("SELECT * FROM mahasiswa ORDER BY id_mhs DESC");
                                                $no=0;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="hapus-user-mhs.php?id_mhs=<?php echo $var['id_mhs']; ?>"><i class="ti-trash" title="hapus"  
                                                        onclick="javascript: return confirm('Anda Yakin Hapus?');" ></i></a>
                                                    <a href="halaman-edit-user-mhs.php?id_mhs=<?php echo $var['id_mhs']; ?>" ><i class="fa fa-edit" title="edit"></i>  
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php } ?>
    ...
    'responsive':true,
        ...
        buttons: [
            ...
            { 
                ...
                title:'',
                messageTop: '<center><img src="<?php echo '../assets/images/header.jpg'; ?>"><br><br><h1>Rekap Data Akun Mahasiswa</h1></center><br>'  
            }
        ]
    } );
    table.draw();
