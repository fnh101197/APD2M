                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Data Rekap Sertifikat</h4>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="header-title">V = Valid TV = Tidak Valid</h3>
                                <div class="data-tables datatable-primary">
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <?php
                                            include 'koneksi.php';
                                            include 'rekap-sertifikat-query.php';
                                            $no=0;
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $no; ?></td>
                                                <td align="left">
                                                    <?php echo $var['nama_mhs']; ?>
                                                </td>
                                                <td><?php echo $var['jurusan']; ?><br><?php echo $var['angkatan']; ?></td>
                                                <td>
                                                    <i class="btn btn-success btn-xs mb-3">
                                                        <strong>
                                                            V (<?php echo $var['PreV']; ?>)
                                                        </strong>
                                                    </i>
                                                    <i class="btn btn-danger btn-xs mb-3">
                                                        <strong>
                                                            TV (<?php echo $var['PreTV']; ?>)
                                                        </strong>
                                                    </i>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <i class="btn btn-danger btn-xs mb-3">
                                                        <strong>
                                                            TV (<?php echo $var['LaiTV']; ?>)
                                                        </strong>
                                                    </i>
                                                </td>
                                                <td>
                                                    <a href="detail-rekap-mhs.php?id_mhs=<?php echo $var['id_mhs'];  ?>" class="btn btn-primary btn-xs mb-3">
                                                        <i class="fa fa-image">
                                                            Lihat
                                                        </i>    
                                                    </a>
