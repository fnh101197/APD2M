...
<html class="no-js" lang="en">
    <?php 
        ...
        $query=mysql_query("SELECT * from sertifikat LEFT JOIN kategori_sertifikat ON sertifikat.kategori_sertifikat=kategori_sertifikat.nm_ks where id_sertifikat='$id_sertifikat'");
    ?>
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Edit Sertifikat Lain-lain Mahasiswa</title>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="edit-sdl.php" method="POST" name="input" novalidate="" ENCTYPE="multipart/form-data">
                                    <h4 class="header-title">Edit Data Lain-lain</h4>
                                    <input type="hidden" name="id_sertifikat" value="<?php echo $id_sertifikat;?>">
                                        <div class="form-group">
                                            <label for="">Kategori</label>
                                            <select name="kategori_sertifikat" id="kategori_sertifikat" class="form-control col-4">
                                            <?php 

                                            include 'koneksi.php';
                                            $query = mysql_query("SELECT * FROM kategori_sertifikat");
                                            while ($kategori=mysql_fetch_array($query)){ 
                                                if ($row['kategori_sertifikat']==$kategori['nm_ks']){
                                                    $select="selected";
                                                }else{
                                                    $select="";
                                                }
                                                echo "<option $select>".$kategori['nm_ks']."</option>";
                                            }
                                            ?>
                                            </select>
                                        </div>
                                        ...
                                        <? } ?>
                                        <div>
                                            <input type="submit" name="edit-sdl" class="btn btn-primary">
