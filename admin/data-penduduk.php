                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left"><?php echo $var['nik']; ?></td>
                                                <td align="left"><?php echo $var['tmp_lahir']; ?>, <?php echo TanggalIndoString($var['tgl_lahir']); ?></td>
                                                <td>
                                                    <a href="tinjau-data-kependudukan.php?id_kependudukan=<?php echo $var['id_kependudukan'] ?>" class="btn btn-primary btn-xs mb-3" title="butuh perbaikan" target="_BLANK">Lihat</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
    ...
    'responsive':true,
        ...
        buttons: [
            ...
            { 
                ...
                title:'',
                messageTop: '<center><img src="<?php echo '../assets/images/header.jpg'; ?>"><br><br><h1>Rekap Data Kependudukan</h1></center><br>'  
            }
        ]
    } );
    table.draw();
