...
<head>
    ...
    <title>Akun Mahasiswa - Aplikasi Data Dokumen Mahasiswa D3 Sistem Informasi Universitas Pakuan</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Akun Mahasiswa</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            ...
                            ?>
                            <div class="card-body">
                                <form action="edit-user-mhs.php" method="POST" name="input">
                                <h4 class="header-title">Edit Akun Mahasiswa</h4>
                                <input type="hidden" name="id_mhs" value="<?php echo $id_mhs;?>">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Nama</label>
                                                <input type="text" class="form-control" id="" name="nama_mhs" value="<?php echo $row['nama_mhs']; ?>" required="" placeholder="nama">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">NPM</label>
                                                <input type="text" class="form-control" id="" name="npm" value="<?php echo $row['npm']; ?>" required="" placeholder="npm">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="" name="angkatan" value="<?php echo $row['angkatan']; ?>" required="" placeholder="Angkatan">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Jurusan</label>
                                                <input type="text" class="form-control" id="" name="jurusan" value="<?php echo $row['jurusan']; ?>" required="" placeholder="jurusan">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="disabledTextInput" name="fakultas" value="<?php echo $row['fakultas']; ?>" required="" placeholder="fakultas">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Username</label>
                                                <input type="text" class="form-control" id="" name="username" value="<?php echo $row['username']; ?>" required="" placeholder="nama">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" id="" name="password" value="<?php echo $row['password']; ?>" required="" placeholder="password">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Jenis Kelamin</label>
                                                <select type="text" class="form-control" id="" name="jk"  required="">
                                                    <option>
                                                        <?php echo $row['jk']; ?>
                                                    </option>
                                                    <option>
                                    ...
                                    <div>
                                        <input type="submit" name="edit-user-mhs" class="btn btn-primary">
