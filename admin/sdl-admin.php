                            ...
                            <div class="row">
                                <div class="iv-left col-6">
                                    <div class="header-title">
                                       <h4 class="header-title">Data Lain-lain</h4>
                                    </div>
                                </div>
                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                $reload = "sdl-admin.php?page=true&keyword=$keyword";
                                               $sql =
                                                    "SELECT
                                                        s.id_sertifikat, 
                                                        s.asal,
    ...
    'responsive':true,
        ...
        buttons: [
            ...
            { 
                ...
                className: 'btn btn-primary btn-xs mb-3',
                title:'',
                messageTop: '<center><img src="<?php echo '../assets/images/header.jpg'; ?>"><br><br><h1>Rekap Sertifikat Lain-lain</h1></center><br>' 
            }
        ]
    } );
    table.draw();
