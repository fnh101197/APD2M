                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form class="needs-validation" novalidate="" method="POST" action="tambah-keluarga.php" name="input" enctype="multipart/form-data">
                                        <input type="hidden" name="id_mhs" value="<?php echo $id_mhs;?>">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control col-6" id="" name="jml_sdr"  placeholder="Masukan Jumlah Saudara Kandung" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Nama Ayah</label>
                                            <input type="text" class="form-control col-6" id="" name="nm_ayah"  placeholder="Masukan Nama Ayah" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Nama Ibu</label>
                                            <input type="text" class="form-control col-6" id="" name="nm_ibu" placeholder="Masukan Nama Ibu" required="">
                                        </div>
                                        <div class="form-group">
