                                            ...
                                            <tr>
                                                <?php
                                                    ...
                                                    <?}else{?>
                                                        ...
                                                        <td>
                                                            <a href="../sidama/assets/images/sertifikat/<?php echo $var['kategori_sertifikat']; ?>/<?php echo $var['gambar']; ?>" target="_blank"><i type="" name="" class="fa fa-image"> DOC</i></a>
                                                        </td>
    ...
    'responsive':true,
        ...
        buttons: [
            { extend: 'excel', className: 'btn btn-primary btn-xs mb-3' },
            {
                ...
                messageTop: '<center><img src="<?php echo 'assets/images/header.jpg'; ?>"><br><br><h1>Rekap Sertifikat</h1></center><br><h3><table><tr><td>Nama</td><td> : <?php echo $var['nama_mhs']; ?></td></tr><tr><td>NPM</td><td> : <?php echo $var['npm']; ?></td></tr><tr><td>Jurusan</td><td> : <?php echo $var['jurusan']; ?></td></tr></table></h3><br>'  
            }
        ]
    } );
    table.draw();
