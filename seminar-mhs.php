                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <button class="btn btn-primary btn-xs mb-3" data-toggle="modal" data-target=".bd-example-modal-lg" type="button"><i class="fa fa-user-plus"> Tambah Seminar</i></button>&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Tambah Seminar</h5>
                                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                </div>
                                                <!-- Server side start -->
                                                    <div class="card-body">
                                                        <form class="needs-validation" novalidate="" method="POST" action="tambah-seminar.php" name="input" enctype="multipart/form-data">
                                                            <?php $id_mhs=$_SESSION['id_mhs']; ?>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-8 mb-3">
                                                                    <label for="validationCustom05">Keterangan Seminar</label>
                                                                    <input type="text" class="form-control" id="validationCustom05" placeholder="Keterangan Seminar yang Diikuti" name="keterangan" required="">
                                                                   <div class="invalid-feedback">
                                                                        Masukan Keterangan Seminar
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-row">
        ...
        buttons: [
            {
                ...
                messageTop: '<center><img src="<?php echo 'assets/images/header.jpg'; ?>"><br><br><h1>Rekap Seminar</h1></center><br><h3><table><tr><td>Nama</td><td> : <?php echo $var['nama_mhs']; ?></td></tr><tr><td>NPM</td><td> : <?php echo $var['npm']; ?></td></tr><tr><td>Jurusan</td><td> : <?php echo $var['jurusan']; ?></td></tr></table></h3><br>' 
            },
            {
                extend: 'excel',
                text: 'Excel',
                title: 'Seminar <?php echo $_SESSION['nama_mhs']; ?>',
