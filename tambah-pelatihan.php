<?php
    ...
    $target_dir = "assets/images/sertifikat/pelatihan/";
    if(isset($_POST['input'])){
        ...
        if($ukuran_file <= 1000000){
            ...
            if( ($format == "jpg") or ($format == "png")){
                ...
                // Validasi upload (hasil true jika upload berhasil)
                    header('location:pelatihan-mhs.php');
                }else{ // else upload gagal
                    echo 'Upload gagal. <a href="pelatihan-mhs.php">Kembali</a>';
                }
 
            }else{ // else validasi format
                echo 'Format yang diizinkan hanya JPG dan PNG <a href="pelatihan-mhs.php">Kembali</a>';
            }
 
        }else{ // else validasi ukuran file
            echo 'File terlalu besar. Max. 1 MB <a href="pelatihan-mhs.php">Kembali</a>';
        }
 
    }else{ // else validasi error
        echo 'Ada '.$error.' error. Gagal upload. <a href="pelatihan-mhs.php">Kembali</a>';
    }  
}
...
include 'koneksi.php';
    $target_dir = "assets/images/sertifikat/pelatihan/";
    $target_dir2 = "assets/images/sertifikatb/pelatihan/";
    if(isset($_POST['input'])){
