                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <a href="assets/images/dokumen/ijazah/<?php if ($var['file_ijazah']==null) {
                                                                echo "400-image-not-found.jpg";
                                                            }else{
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php 
                                            ...
                                            $var=mysql_fetch_array($query)
                                        ?>
                                        <form class="needs-validation" novalidate="" method="POST" action="tambah-penduduk.php" name="input" enctype="multipart/form-data">
                                        <input type="hidden" name="id_mhs" value="<?php echo $id_mhs;?>">
                                         <div class="form-group">
                                            <label for="">NIK</label>
                                            <input type="text" class="form-control col-6" id="" name="nik"  placeholder="Masukan NIK" required="">
                                        </div>
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control col-6" id="" name="tmp_lahir"  placeholder="Masukan Tempat Lahir" required="">
                                        </div>
                                         <div class="form-group">
                                            <label for="">Tanggal Lahir</label>
                                            <input type="date" class="form-control col-6" id="" name="tgl_lahir"  placeholder="Masukan Tanggal Lahir" required="" value="<?php echo date("Y-m-d");?>">
                                        </div>
                                         <div class="form-group">
                                            <label for="">Golongan Darah (Jika tidak tahu masukan -)</label>
                                            <input type="text" class="form-control col-6" id="" name="gol_darah"  placeholder="Masukan Golongan Darah" required="">
                                        </div>
                                         <div class="form-group">
                                            <label for="">Alamat</label>
                                            <input type="text" class="form-control col-6" id="" name="alamat"  placeholder="Masukan Alamat" required="">
                                        </div>
                                         <div class="form-group">
                                            <label for="">Kelurahan/Desa</label>
                                            <input type="text" class="form-control col-6" id="" name="kelurahan"  placeholder="Masukan Kelurahan/Desa" required="">
                                        </div>
                                         <div class="form-group">
                                            <label for="">Kecamatan</label>
                                            <input type="text" class="form-control col-6" id="" name="kecamatan"  placeholder="Masukan Kecamatan" required="">
                                        </div>
                                         <div class="form-group">
                                            <label for="">Kabupaten/Kota</label>
                                            <input type="text" class="form-control col-6" id="" name="kabupaten"  placeholder="Masukan Kabupaten" required="">
                                        </div>
                                         <div class="form-group">
                                            <label for="">Provinsi</label>
                                            <input type="text" class="form-control col-6" id="" name="provinsi"  placeholder="Masukan Provinsi" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">File Kartu Keluarga</label>
                                            <input  name="gambar" class="form-control col-6" type="file" required="">
                                        </div>
                                        <div class="row">
                                            &nbsp;
                                            &nbsp;
                                            ...
                                            <div>
                                                <a href="profil.php" onclick="javascript: return confirm('Anda Yakin Keluar?');">
                                                    <input type="" name="" class="btn btn-danger col-4" value="Batal">
                                                </a>
                                            </div> 
                                        </div>
                                        </form>
