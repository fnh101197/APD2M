<?php
    ...
    $target_dir = "assets/images/sertifikat/lain-lain/";
    if(isset($_POST['input'])){
        ...
        if($ukuran_file <= 1000000){
            ...
            if( ($format == "jpg") or ($format == "png")){
                ...
                // Validasi upload (hasil true jika upload berhasil)
                    ...
                    echo 'Upload gagal. <a href="sdl-mhs.php">Kembali</a>';
                }
 
            }else{ // else validasi format
                echo 'Format yang diizinkan hanya JPG dan PNG <a href="sdl-mhs.php">Kembali</a>';
            }
 
        }else{ // else validasi ukuran file
            echo 'File terlalu besar. Max. 1 MB <a href="sdl-mhs.php">Kembali</a>';
        }
 
    }else{ // else validasi error
        echo 'Ada '.$error.' error. Gagal upload. <a href="sdl-mhs.php">Kembali</a>';
    }  
}
...
include 'koneksi.php';
    $target_dir = "assets/images/sertifikat/lain-lain/";
    $target_dir2 = "assets/images/sertifikatb/lain-lain/";
    if(isset($_POST['input'])){
