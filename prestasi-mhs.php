                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <h4 class="header-title">Prestasi</h4>&nbsp;&nbsp;&nbsp;
                                    <button class="btn btn-primary btn-xs mb-3" data-toggle="modal" data-target=".bd-example-modal-lg" type="button"><i class="fa fa-user-plus"> Tambah Prestasi</i></button>&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="modal fade bd-example-modal-lg">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <!-- Server side start -->
                                                <div class="card-body">
                                                    <form class="needs-validation" novalidate="" method="POST" action="tambah-prestasi.php" name="input" enctype="multipart/form-data">
                                                        <?php $id_mhs=$_SESSION['id_mhs']; ?>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-8 mb-3">
                                                                <label for="validationCustom05">Keterangan Prestasi</label>
                                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Keterangan Prestasi Kepanitian" name="keterangan" required="">
                                                               <div class="invalid-feedback">
                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="hapus-prestasi.php?id_sertifikat=<?php echo $var['id_sertifikat'] ?>" onclick="javascript: return confirm('Anda Yakin Hapus?');"><i class="ti-trash" title="Cetak"></i></a>
                                                    <a href="halaman-edit-prestasi.php?id_sertifikat=<?php echo $var['id_sertifikat'] ?>"><i class="fa fa-edit" title="Edit"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
    ...
    'filter':true,
        ...
        buttons: [
            ...
            },
            {
                extend: 'excel',
                text: 'Excel',
                title: 'Prestasi <?php echo $_SESSION['nama_mhs']; ?>',
