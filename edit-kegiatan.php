...
if (!empty($_FILES["gambar"]["tmp_name"]))
    {
        $namafolder="assets/images/sertifikat/kegiatan/";
        ...
        else { die("Jenis gambar yang anda kirim salah. Harus .jpg .png ukuran max. 1 MB <a href='kegiatan-mhs.php'>Kembali<a/>"); }
    }

if (!empty($_FILES["gambar2"]["tmp_name"]))
    {
        $namafolder="assets/images/sertifikatb/kegiatan/";
