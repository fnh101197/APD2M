                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Kegiatan</h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <button class="btn btn-primary btn-xs mb-3" data-toggle="modal" data-target=".bd-example-modal-lg" type="button"><i class="fa fa-user-plus"> Tambah Kegiatan</i></button>&nbsp;&nbsp;&nbsp;
                                    ...
                                    <div class="modal fade bd-example-modal-lg">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <!-- Server side start -->
                                                <div class="card-body">
                                                    <form class="needs-validation" novalidate="" method="POST" action="tambah-kegiatan.php" name="input" enctype="multipart/form-data">
                                                        <?php $id_mhs=$_SESSION['id_mhs']; ?>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-8 mb-3">
                                                                <label for="validationCustom05">Keterangan Kegiatan Kepanitiaan</label>
                                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Keterangan Kegiatan Kepanitian" name="keterangan" required="">
                                                               <div class="invalid-feedback">
                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="hapus-kegiatan.php?id_sertifikat=<?php echo $var['id_sertifikat'] ?>" onclick="javascript: return confirm('Anda Yakin Hapus?');"><i class="ti-trash" title="Cetak"></i></a>
                                                    <a href="halaman-edit-kegiatan.php?id_sertifikat=<?php echo $var['id_sertifikat'] ?>"><i class="fa fa-edit" title="Edit"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
        ...
        buttons: [
            {
                ...
                messageTop: '<center><img src="<?php echo 'assets/images/header.jpg'; ?>"><br><br><h1>Rekap Kegiatan</h1></center><br><h3><table><tr><td>Nama</td><td> : <?php echo $var['nama_mhs']; ?></td></tr><tr><td>NPM</td><td> : <?php echo $var['npm']; ?></td></tr><tr><td>Jurusan</td><td> : <?php echo $var['jurusan']; ?></td></tr></table></h3><br>' 
            },
            {
                extend: 'excel',
                text: 'Excel',
