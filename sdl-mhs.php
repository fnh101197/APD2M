                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Lain - lain</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <h4 class="header-title">Lain - lain</h4>&nbsp;&nbsp;&nbsp;
                                    <button class="btn btn-primary btn-xs mb-3" data-toggle="modal" data-target=".bd-example-modal-lg" type="button"><i class="fa fa-user-plus"> Tambah Data Lain - lain</i></button>&nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Tambah Lain - lain</h5>
                                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                </div>
                                                <!-- Server side start -->
                                                <div class="card-body">
                                                    <form class="needs-validation" novalidate="" method="POST" action="tambah-sdl.php" name="input" enctype="multipart/form-data">
                                                        <?php $id_mhs=$_SESSION['id_mhs']; ?>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-8 mb-3">
                                                                <label for="validationCustom05">Keterangan data lain - lain</label>
                                                                <input type="text" class="form-control" id="validationCustom05" placeholder="Keterangan lain - lain Kepanitian" name="keterangan" required="">
                                                               <div class="invalid-feedback">
                                                                    Masukan Keterangan Prestasi
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <div class="controls">
                                                                  <input name="gambar" class="form-control" type="file"  placeholder="" id="validationCustom05" required="">
                                                                    <div class="invalid-feedback">
                                                                       Jika gambar hanya 1 muka masukan disini, jika gambar 2 masukan gambar depan belakang
                                                                    </div>
                                                            ...
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <div class="controls">
                                                                  <input name="gambar2" class="form-control" type="file"  placeholder="" id="validationCustom05" value="not.jpg">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- Server side end -->
                                    ...
                                    <table id="dataTable2" class="text-center" width="100%">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><a href="hapus-sdl.php?id_sertifikat=<?php echo $var['id_sertifikat'] ?>" onclick="javascript: return confirm('Anda Yakin Hapus?');"><i class="ti-trash" title="Cetak"></i></a>
                                                    <a href="halaman-edit-sdl.php?id_sertifikat=<?php echo $var['id_sertifikat'] ?>"><i class="fa fa-edit" title="Edit"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
        ...
        buttons: [
            {
                ...
                messageTop: '<center><img src="<?php echo 'assets/images/header.jpg'; ?>"><br><br><h1>Rekap Prestasi</h1></center><br><h3><table><tr><td>Nama</td><td> : <?php echo $var['nama_mhs']; ?></td></tr><tr><td>NPM</td><td> : <?php echo $var['npm']; ?></td></tr><tr><td>Jurusan</td><td> : <?php echo $var['jurusan']; ?></td></tr></table></h3><br>' 
            },
            {
                extend: 'excel',
                text: 'Excel',
                title: 'Kepanitiaan <?php echo $_SESSION['nama_mhs']; ?>',
