...
if (!empty($_FILES["gambar"]["tmp_name"]))
    {
        $namafolder="assets/images/sertifikat/prestasi/";
        ...
        else { die("Jenis gambar yang anda kirim salah. Harus .jpg .png ukuran max. 1 MB <a href='prestasi-mhs.php'>Kembali<a/>"); }
    }

if (!empty($_FILES["gambar2"]["tmp_name"]))
    {
        $namafolder="assets/images/sertifikatb/prestasi/";
...
$query="UPDATE sertifikat SET asal='$asal', tgl_peroleh='$tgl_peroleh', keterangan='$keterangan',status_sertifikat='Pengajuan' WHERE id_sertifikat='$id_sertifikat'";
