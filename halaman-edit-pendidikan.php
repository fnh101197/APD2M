                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <!-- heading area end-->
                                        <form action="edit-pendidikan.php" method="POST" name="input" novalidate="" ENCTYPE="multipart/form-data">
                                        <input type="hidden" name="id_mhs" value="<?php echo $id_mhs;?>">
                                            <div class="form-group">
                                            <label for="">Tahun Lulus</label>
                                            <input type="text" class="form-control col-6" name="thn_lulus" value="<?php echo $var['thn_lulus']; ?>" required="" placeholder="Masukan Tahun Lulus"> 
                                        </div>
                                         <div class="form-group">
                                            <label for="">Asal Sekolah</label>
                                            <input type="text" class="form-control col-6" id="" name="asal_sekolah" value="<?php echo $var['asal_sekolah']; ?>" placeholder="Masukan Asal Sekolah" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Jurusan Sekolah</label>
                                            <input type="text" class="form-control col-6" id="" name="jurusan_sekolah" value="<?php echo $var['jurusan_sekolah']; ?>" placeholder="Masukan Nama Jurusan Sekolah" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Tahun Masuk</label>
                                            <input type="text" class="form-control col-6" id="" name="thn_angkatan" value="<?php echo $var['thn_angkatan']; ?>"placeholder="Masukan Tahun Masuk" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">File Ijazah Depan</label>
                                            <input value="" name="file_ijazah" class="form-control col-6" type="file" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">File Ijazah Belakang</label>
                                            <input value="assets/images/dokumen/ijazahb/<?php echo $var['file_ijazahb']; ?>" name="file_ijazahb" class="form-control col-6" type="file" required="">
                                        </div>
                                        <div class="row">
                                            &nbsp;
                                            &nbsp;
