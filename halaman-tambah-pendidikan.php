                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php 
                                            ...
                                            $var=mysql_fetch_array($query)
                                        ?>
                                        <form class="needs-validation" novalidate="" method="POST" action="tambah-pendidikan.php" name="input" enctype="multipart/form-data">
                                        <input type="hidden" name="id_mhs" value="<?php echo $id_mhs;?>">
                                            <div class="form-group">
                                            <label for="">Tahun Lulus</label>
                                            <input type="text" class="form-control col-6" name="thn_lulus"  required="" placeholder="Masukan Tahun Lulus"> 
                                        </div>
                                         <div class="form-group">
                                            <label for="">Asal Sekolah</label>
                                            <input type="text" class="form-control col-6" id="" name="asal_sekolah"  placeholder="Masukan Asal Sekolah" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Jurusan Sekolah</label>
                                            <input type="text" class="form-control col-6" id="" name="jurusan_sekolah"  placeholder="Masukan Nama Jurusan Sekolah" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="">Tahun Masuk</label>
                                            <input type="text" class="form-control col-6" id="" name="thn_angkatan" placeholder="Masukan Tahun Masuk" required="">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input  name="gambar2" class="form-control col-6" type="file" required="">
                                        </div>
                                        <div class="row">
                                            &nbsp;
                                            &nbsp;
